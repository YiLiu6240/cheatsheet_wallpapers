...
\definecolor{solarized_brred}{HTML}{cb4b16}
...
\titleformat{\section}
{\color{solarized_brred}\normalfont\large\bfseries}
{\color{solarized_brred}\thesection}{1em}{}
\titleformat{\subsection}
...
\begin{center}
    ...
    {\color{solarized_blue} \Large{\textbf{Probability Cheatsheet v2.0}}} \\
